...
const MultiplayerGameScreen = ({ scenario, roundNumber, onAdvanceToVerdicts }: MultiplayerGameScreenProps) => {
  ...
  return (
    <div className="game-screen h-screen flex flex-col">
      <div className="game-content flex-1 flex gap-8 p-6">
        <div className="main-area flex-1 flex flex-col justify-center">
        ...
        <div className="sidebar w-80 flex flex-col justify-center space-y-6">
